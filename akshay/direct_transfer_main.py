...
parser.add_argument("--lr_domain", type=float, default=0.01) #
...
print()
print("Running model...")
results = train_model(train_data, dev_data_target, test_data_target, net, None, args)
