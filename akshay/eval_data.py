...
class EvalData(data.Dataset):
    #Expecting data to be of dims: (around EMBEDDING_DIM, 4,#negs)
    ...
    def __getitem__(self, i):
        ...
        garbage1,comp1 = pad(torch.zeros(1, EMBEDDING_DIM, 25), mainQ_title)
        garbage2,comp2 = pad(torch.zeros(1, EMBEDDING_DIM, 100), mainQ_body)
        comp1=[1.0/comp1[0]]
        comp2=[1.0/comp2[0]]
